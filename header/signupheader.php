...
<html lang="en">
    ...
    <head>
        ...
        <script type="text/javascript" src="js\sregvalidation.js">
        </script> 
    </head>
    <!--end of head-->
    <!--body begins here-->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse navHeaderCollapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><form action="clogin.php"><button type="submit" name="submit" class="btn btn-primary" style="width:100px;margin-top:7%;font-size:16px;">Login</button></form></li>
                            </ul>
                        </div>
                    </div>
                </nav>
